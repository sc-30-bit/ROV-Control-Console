...
QT_MOC_LITERAL(1, 5, 10), // "sendframes"
QT_MOC_LITERAL(2, 16, 0), // ""
QT_MOC_LITERAL(3, 17, 6), // "frame1"
QT_MOC_LITERAL(4, 24, 6), // "frame2"
QT_MOC_LITERAL(5, 31, 6), // "frame3"
QT_MOC_LITERAL(6, 38, 5), // "start"
QT_MOC_LITERAL(7, 44, 5) // "close"

    },
    "rtsp\0sendframes\0\0frame1\0frame2\0frame3\0"
    "start\0close"
};
...
static const uint qt_meta_data_rtsp[] = {
 ...
 // signals: parameters
    QMetaType::Void, QMetaType::QPixmap, QMetaType::QPixmap, QMetaType::QPixmap,    3,    4,    5,
...
void rtsp::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendframes((*reinterpret_cast< QPixmap(*)>(_a[1])),(*reinterpret_cast< QPixmap(*)>(_a[2])),(*reinterpret_cast< QPixmap(*)>(_a[3]))); break;
        ...
        {
            using _t = void (rtsp::*)(QPixmap , QPixmap , QPixmap );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&rtsp::sendframes)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void rtsp::sendframes(QPixmap _t1, QPixmap _t2, QPixmap _t3)
{
